...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/HoiChoiTvAddaa'),
...
async def repo_(client, message):
    ...
    await message.reply("<b>The source code of this bot is not public and can't be found at <a href=https://google.com>GOOGLE.</a>\nYou can't deploy your own bot and use in your group.\n\nFeel free to report bug if you find any 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
